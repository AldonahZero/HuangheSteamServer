    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text='角色编码', max_length=30, verbose_name='角色编码')),
                ('status', models.IntegerField(choices=[(1, '正常'), (2, '停用')], default=1, help_text='角色状态：1-正常 2-停用', verbose_name='角色状态：1-正常 2-停用')),
                ('sort', models.IntegerField(default=0, help_text='角色排序', verbose_name='角色排序')),
