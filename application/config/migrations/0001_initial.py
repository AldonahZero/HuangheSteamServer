    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='配置名称', max_length=150, verbose_name='配置名称')),
                ('sort', models.IntegerField(default=0, help_text='配置排序', verbose_name='配置排序')),
                ('note', models.CharField(help_text='配置备注', max_length=255, null=True, verbose_name='配置备注')),
            ],
            options={
                'verbose_name': '配置表',
                'verbose_name_plural': '配置表',
                'db_table': 'django_config',
            },
        ),
    ]
