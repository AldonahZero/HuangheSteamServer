...
class Menu(BaseModel):
    # 菜单标题
    title = models.CharField(max_length=150, verbose_name="菜单标题", help_text="菜单标题")
    # 菜单图标
    icon = models.CharField(max_length=50, verbose_name="菜单图标", help_text="菜单图标")
    # 上级ID
    parent_id = models.IntegerField(default=0, verbose_name="上级ID", help_text="上级ID")
    # 菜单路径
    path = models.CharField(null=True, max_length=255, verbose_name="菜单路径", help_text="菜单路径")
    # 菜单组件
    component = models.CharField(null=True, max_length=255, verbose_name="菜单组件", help_text="菜单组件")
    # 打开方式
    target = models.CharField(max_length=30, verbose_name="打开方式", help_text="打开方式")
    # 权限节点
    ...
    hide = models.IntegerField(choices=HIDE_CHOICES, default=1, verbose_name="是否可见：0-可见 1-不可见",
                               help_text="是否可见：0-可见 1-不可见")
    # 排序
